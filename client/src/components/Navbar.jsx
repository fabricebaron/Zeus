    ...
    return (   
      <nav className='w-full flex md: justify-center justify-between items-center p-4'>
            ...
            <div className="flex relative">
             {toggleMenu
              ? <AiOutlineClose fontSize="text-white md:hidden cursor-pointer" onClick={() => setToggleMenu(false)} />
              : <HiMenuAlt4 fontSize="text-white md:hidden cursor-pointer" onClick={() => setToggleMenu(true)} />}
              {toggleMenu && (
                <ul
